...
Focused on computational methods (Computational Fluid Dynamic, Finite Element Analysis, Flutter analysis) and Composites. I worked with Prof. Henry Sodano on self healing polymers.