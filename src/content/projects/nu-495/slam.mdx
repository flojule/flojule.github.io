...
endDate: "2026-03-31"
skills: ["C++", "ROS 2", "SLAM", "Localization"]
...
I built a full SLAM stack from the ground up for a TurtleBot3 differential-drive robot in ROS 2. The robot uses a LIDAR sensor to detect cylindrical landmarks and maintains a joint estimate of its own pose and all landmark positions.
