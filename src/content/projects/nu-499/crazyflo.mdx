...
<div class="my-4 rounded-2xl border border-base-300 bg-base-200/40 p-3 text-sm text-base-content/75">
  ...
  & J = J_{\mathrm{track}}
    ...
    + J_{\mathrm{obs}} \\
  \text{s.t.} \quad
  & \text{dynamics},\ \text{boundary conditions},\ \text{speed/acceleration/jerk limits}, \\
  & \text{unit cable directions},\ \text{tension bounds},\ \text{drone separation}.
  \end{aligned}
  $$
</div>
...
- Unit cable directions and tension bounds.
